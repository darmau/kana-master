...
(function () {
  ...
  const ICONS = {
    ...
    reader:
      '<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M21 4H3a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1Zm-1 14h-7V6h7v12ZM11 6v12H4V6h7Z" fill="currentColor"/><path d="M5.5 8.5h4v1.4h-4V8.5Zm0 3h4v1.4h-4v-1.4Zm9-3h4v1.4h-4V8.5Zm0 3h4v1.4h-4v-1.4Z" fill="currentColor"/></svg>',
    tts:
