...
export const SETTINGS_KEYS = [
  ...
  "blacklist",
  // Reader study aids — kept in sync alongside jlptLevel/targetLang because
  // re-enabling them per article would be friction.
  "readerHideFurigana", "readerHideTranslation",
];
...
export const DEFAULTS = {
  ...
  ttsVoice: "alloy",
  debugMode: false,
  readerHideFurigana: false,
  readerHideTranslation: false,
};
